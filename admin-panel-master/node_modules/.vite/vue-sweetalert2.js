...
e.exports = function() {
  const t2 = Object.freeze({ cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer" }), e2 = (t3) => {
    ...
    e3.showConfirmButton || e3.showDenyButton || e3.showCancelButton || ot(n3), $(n3, e3, "actions"), St(i2, "confirm", e3), St(s2, "deny", e3), St(a2, "cancel", e3), Et(i2, s2, a2, e3), e3.reverseButtons && (n3.insertBefore(a2, o2), n3.insertBefore(s2, o2), n3.insertBefore(i2, o2)), _(o2, e3.loaderHtml), $(o2, e3, "loader");
  };
  ...
  function St(t3, e3, o2) {
    st(t3, o2["show".concat(n2(e3), "Button")], "inline-block"), _(t3, o2["".concat(e3, "ButtonText")]), t3.setAttribute("aria-label", o2["".concat(e3, "ButtonAriaLabel")]), t3.className = y[e3], $(t3, o2, "".concat(e3, "Button")), G(t3, o2["".concat(e3, "ButtonClass")]);
  }
  function Tt(t3, e3) {
  ...
  const Wt = (t3, e3) => {
    ...
    const n3 = V();
    _(n3, e3.closeButtonHtml), $(n3, e3, "closeButton"), st(n3, e3.showCloseButton), n3.setAttribute("aria-label", e3.closeButtonAriaLabel);
  }, Yt = (t3, e3) => {
...
var n = e.exports;
var vue_sweetalert_es_default = class {
...
// dep:vue-sweetalert2
var vue_sweetalert2_default = vue_sweetalert_es_default;
export {
